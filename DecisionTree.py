...
# Exercise 3, 
# Decision Tree, with Gini Impurity Index and Max Tree Depth =5
...
plt.legend(["DescTree Model 1 Validation Dataset"], loc ="lower right", prop = {'size': 8})
plt.show()   
...
plt.xlabel("False Positive Rate.", size = 8,)
plt.ylabel("True Positive Rate", size = 8)
plt.legend(["DescTree  Model 2 Validation Dataset"], loc ="lower right", prop = {'size': 8})
plt.show()   
...
plt.xlabel("False Positive Rate.", size = 8,)
plt.ylabel("True Positive Rate", size = 8)
plt.legend(["DescTree Model 1 Test Dataset"], loc ="lower right", prop = {'size': 8})
plt.show()   
